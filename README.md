...
2. Make a copy of the apk and rename it to a `.zip` file. Then extract it and Copy the complete `assets/` directory into the `3.37/` folder.
...
1. Copy the owned APK containing the game assets into the `4.7/` folder and
   name it `base.apk`.
2. Make a copy of the apk and rename it to a `.zip` file. Then extract it and copy its complete `assets/` directory into the `4.7/` folder.
